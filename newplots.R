...
x1 <- b0 + b1*train70$Average.Value..Fill.Speed..FillSp. + b2*median(train70$Average.Value..Job.Cycle.Time..Job.Ct.)+
     b3*median(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)+
      b4*median(train70$Fill...Pack.Integral..End.of.Cavity..6..EOC.fpi..6.) + b5*median(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)+
      b6*median(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)+
      b7*median(train70$Sequence.Time..Injection.Forward..IF.tm.)
...
x2 <- b0 + b1*median(train70$Average.Value..Fill.Speed..FillSp.) + b2*median(train70$Average.Value..Job.Cycle.Time..Job.Ct.)+
  b3*median(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)+
  b4*(train70$Fill...Pack.Integral..End.of.Cavity..6..EOC.fpi..6.) + b5*median(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)+
  b6*median(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)+
  b7*median(train70$Sequence.Time..Injection.Forward..IF.tm.)
...
xconstant <- b0 +  b2*median(train70$Average.Value..Job.Cycle.Time..Job.Ct.)+
  b3*median(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)+
   b5*median(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)+
  b6*median(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)+
  b7*median(train70$Sequence.Time..Injection.Forward..IF.tm.)
