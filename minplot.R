...
x1 <- b0 + b1*train70$Average.Value..Fill.Speed..FillSp. + b2*quantile(train70$Average.Value..Job.Cycle.Time..Job.Ct.)[2]+
  b3*quantile(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)[2]+
  b4*quantile(train70$Fill...Pack.Integral..End.of.Cavity..6..EOC.fpi..6.)[2] + b5*quantile(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)[2]+
  b6*quantile(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)[2]+
  b7*quantile(train70$Sequence.Time..Injection.Forward..IF.tm.)[2]
...
x2 <- b0 + b1*quantile(train70$Average.Value..Fill.Speed..FillSp.)[2] + b2*quantile(train70$Average.Value..Job.Cycle.Time..Job.Ct.)[2]+
  b3*quantile(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)[2]+
  b4*(train70$Fill...Pack.Integral..End.of.Cavity..6..EOC.fpi..6.) + b5*quantile(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)[2]+
  b6*quantile(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)[2]+
  b7*quantile(train70$Sequence.Time..Injection.Forward..IF.tm.)[2]
...
xconstant <- b0 +  b2*quantile(train70$Average.Value..Job.Cycle.Time..Job.Ct.)[2]+
  b3*quantile(train70$Fill...Pack.Integral..End.of.Cavity..2..EOC.fpi..2.)[2]+
  b5*quantile(train70$Fill...Pack.Integral..Post.Gate..6..PST.fpi..6.)[2]+
  b6*quantile(train70$Fill...Pack.Time..End.of.Cavity..1..EOC.fpt..1.)[2]+
  b7*quantile(train70$Sequence.Time..Injection.Forward..IF.tm.)[2]
